...
class RestoreSqlData : public std::enable_shared_from_this<RestoreSqlData> {
 public:
 ...
 protected:
 private:
  butil::Status CheckStoreRegionSqlDataSst();
  butil::Status CheckStoreCfSstMetaSqlDataSst();
  butil::Status CheckIndexRegionSqlDataSst();
  butil::Status CheckIndexCfSstMetaSqlDataSst();
  butil::Status CheckDocumentRegionSqlDataSst();
  butil::Status CheckDocumentCfSstMetaSqlDataSst();
  butil::Status CheckRegionSqlDataSst(std::shared_ptr<dingodb::pb::common::BackupMeta> region_sql_data_sst,
                                      const std::string& file_name);
  butil::Status CheckCfSstMetaSqlDataSst(std::shared_ptr<dingodb::pb::common::BackupMeta> cf_sst_meta_sql_data_sst,
